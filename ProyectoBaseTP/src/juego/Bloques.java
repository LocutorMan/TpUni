...
public class Bloques {
	...
	public static Bloques[] crearMultiplesFilasDeBloques(int filas, int cantPorFila, double x, double y,
			double espacioX, double espacioY) {
		Bloques[] multiplesFilas = new Bloques[filas * cantPorFila]; // Se agrega un array de filas (cada una del tamaño
																		// dado en cantPorFila)
